...
namespace Assignment_Project
{
    public partial class frmHealth : Form
    {
        ...
        {
            dgvPanel.DataSource = expcat.retrieveExpense(uid, "Health");
            dgvPanel.ReadOnly = true;
        }

        private void btnRefresh_Click(object sender, EventArgs e)
        {
            frmHealth_Load(sender, e);
            txtCost.Clear();
            txtDesc.Clear();
            cbxMonth.SelectedIndex = 0;
            cbxPayment.SelectedIndex = 0;
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                if (expcat.addExpense(cbxMonth.Text, Convert.ToInt32(txtCost.Text), cbxPayment.Text, txtDesc.Text, "Health", uid))
                {
        ...
        {
            if (expcat.updateExpense(cbxMonth.Text, Convert.ToInt32(txtCost.Text), cbxPayment.Text, txtDesc.Text, "Health", eid))
            {
