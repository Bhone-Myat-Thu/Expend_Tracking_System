...
namespace Assignment_Project
{
    public partial class frmEducation : Form
    {
        ...
        private void eCost_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void frmEducation_Load(object sender, EventArgs e)
        {
            ...
            dgvPanel.DataSource = expcat.retrieveExpense(uid, "Education");
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (expcat.updateExpense(cbxMonth.Text, Convert.ToInt32(txtCost.Text), cbxPayment.Text, txtDesc.Text, "Education", eid))
            {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                if (expcat.addExpense(cbxMonth.Text, Convert.ToInt32(txtCost.Text), cbxPayment.Text, txtDesc.Text, "Education", uid))
                {
